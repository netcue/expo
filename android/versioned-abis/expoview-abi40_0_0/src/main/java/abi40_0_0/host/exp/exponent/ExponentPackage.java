...
public class ExponentPackage implements ReactPackage {
  ...
  public List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
    ...
    if (isVerified) {
      try {
        ExperienceKey experienceKey = ExperienceKey.Companion.fromRawManifest(mManifest);
        ScopedContext scopedContext = new ScopedContext(reactContext, experienceKey.getUrlEncodedScopeKey());
